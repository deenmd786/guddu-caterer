  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-1/4  md:h-[100vh] bg-[var(--background-secondary)] max-md:flex justify-between items-center custom-shadow">
        <div className=" md:bg-[var(--background-secondary)] md:h-[25vh] shrink-0 shadow-[4px 0 10px rgba(0,0,0,0.2)]">
      ...
      {/* Main content area */}
      <main className="w-full md:w-3/4 bg-gray-100 ">
        <div className="max-h-[91vh] w-full rounded-lg">{children}</div>
