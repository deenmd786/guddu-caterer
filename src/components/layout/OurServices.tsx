    ...
    <div className="md:py-12 bg-[var(--background-secondary)]">
      <div id="scroll-down-section" className="container mx-auto p-4">
        <div className="text-center mb-12">
          <h1 className="text-[var(--text-red)] text-xl font-bold mb-8 border-b pb-3 border-red-600">
            {" "}
            -- Our Services --
          </h1>
          <h2
            className={`font-GreatVibes  text-2xl md:text-4xl mb-6 tracking-widest`}
          >
            Designed to Meet Your{" "}
            <span className="text-[var(--text-red)]">Needs</span>
          </h2>
        </div>
        ...
        <div
          id="services"
          className=" flex flex-col md:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8"
        >
          {linksData.services.map((service: Service) => (
            ...
            >
              <div className="flex flex-col items-center">
                <ImageCard
                  imageUrl={
                    service.imageUrl || "https://via.placeholder.com/300"
                  }
